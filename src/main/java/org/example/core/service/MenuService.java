...
import org.example.core.dto.MenuCreateRequest; // DTO جدید را ایمپورت کنید
import org.example.core.model.Menu;
import org.example.core.model.Permission;
import org.example.core.repository.MenuRepository;
import org.example.core.repository.PermissionRepository; // باید PermissionRepository را Autowire کنید
...
import org.example.core.model.User; // برای استفاده از User
import org.example.core.repository.UserRepository; // برای Autowire کردن UserRepository
