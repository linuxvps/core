...
public class JwtUtil {
    ...
    // **این متد جدید را برای لاگین با گوگل اضافه کنید**
    public String generateToken(String username) {
        Map<String, Object> claims = new HashMap<>();
        // اگر نیاز به افزودن نقش‌ها دارید، باید آن‌ها را از دیتابیس بخوانید
        // و به claims اضافه کنید، اما برای شروع می‌توان خالی گذاشت.
